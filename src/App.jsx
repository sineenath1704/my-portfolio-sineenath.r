    ...
    <LanguageProvider>
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route
            path="/resume"
            element={<ResumeSwitcher />}
          />

          <Route
            path="/Resume_Switcher"
            element={<ResumeSwitcher />}
          />

          <Route
            path="/Resume_Switcher.jsx"
            element={<ResumeSwitcher />}
          />
          ...
          <Route
            path="/project-detail/oneput"
            element={<ProjectDetailONEPUT />}
          />

          <Route
            path="/ProjectDetailONEPUT"
            element={<ProjectDetailONEPUT />}
          />

          <Route
            path="/project-detail/focus-room"
            element={<ProjectDetailFocusRoom />}
          />

          <Route
            path="/ProjectDetailFocusRoom"
            element={<ProjectDetailFocusRoom />}
          />

          <Route
            path="/project-detail/cp-axtra-mile"
            element={<ProjectDetailCPAxtraMile />}
          />

          <Route
            path="/ProjectDetailCPAxtraMile"
            element={<ProjectDetailCPAxtraMile />}
          />

          <Route
            path="/project-detail/herevidence"
            element={<ProjectDetailHerEvidence />}
          />

          <Route
            path="/ProjectDetailHerEvidence"
            element={<ProjectDetailHerEvidence />}
          />

          <Route
            path="/project-detail/sit-hello-world-hippo"
